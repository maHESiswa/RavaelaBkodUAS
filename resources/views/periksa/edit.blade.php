                        ...
                        <form action="{{ route('periksa.update', $periksa->id) }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <select name="id_pasien" id="id_pasien" class="form-control select2 @error('id_pasien') is-invalid @enderror" required>
                                    ...
                                    <option value="{{ $pasien->id }}" {{ (old('id_pasien', $periksa->id_pasien) == $pasien->id) ? 'selected' : '' }}>
                                        {{ $pasien->nama }}
                                    </option>
                                    @endforeach
                                </select>
                                <small class="form-text text-muted">Pilih pasien yang diperiksa</small>
                                @error('id_pasien')
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('catatan') is-invalid @enderror" 
                                    ...
                                    placeholder="Masukkan catatan hasil pemeriksaan">{{ old('catatan', $periksa->catatan) }}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control @error('biaya_periksa') is-invalid @enderror" 
                                        id="biaya_periksa" name="biaya_periksa" value="{{ old('biaya_periksa', $periksa->biaya_periksa) }}" required>
                                </div>
                                ...
                                @enderror
                                <small class="text-muted d-block">Total Biaya: <span id="totalBiaya">Rp {{ number_format(old('biaya_periksa', $periksa->biaya_periksa), 0, ',', '.') }}</span></small>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="obat_id[]" id="obat_id" class="form-control select2 @error('obat_id') is-invalid @enderror" 
                                    ...
                                    <option value="{{ $obat->id }}" 
                                        {{ (in_array($obat->id, old('obat_id', $selected_obats))) ? 'selected' : '' }}>
